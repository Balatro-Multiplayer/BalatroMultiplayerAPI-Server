...
// /api/releases. GET /api/mods is the compact list (a mod is ranked-allowed
// iff rankedVersion is non-null, see schema.ts's rankedVersion doc comment);
// GET /api/mods/:id adds everything else, including the hash the launcher
// verifies a ranked mod's installed folder against. :id is the public id or
// the Thunderstore full name.
//
