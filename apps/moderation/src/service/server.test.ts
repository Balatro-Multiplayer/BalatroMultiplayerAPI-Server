...
describe('moderation HTTP server — fail-closed when model not loaded', () => {
	it('serves 503 on /moderate and /health, surfacing the load-error reason and default (unset) list state', async () => {
